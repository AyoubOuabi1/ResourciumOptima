  ...
  <div class="container-fluid d-flex justify-content-around">
    ...
    <ul class="navbar-nav  bg-transparent flex-nowrap ms-auto">
      ...
      <li class="nav-item dropdown no-arrow">
        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small">Anass  Fadil</span><img class="border rounded-circle img-profile" src="https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg"></a>
